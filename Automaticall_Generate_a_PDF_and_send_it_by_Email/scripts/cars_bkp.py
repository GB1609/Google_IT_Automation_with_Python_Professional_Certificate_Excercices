...
def cars_dict_to_table(car_data):
    ...
    for item in car_data:
        table_data.append([item["id"], format_car(item["car"]), "€"+item["price"].strip("$"), item["total_sales"]])
    return table_data
...
def email_send_report(summary):
    ...
    receiver = "{}@example.com".format("student-01-c7eda27642cb")
...
def main(argv):
    ...
    data = load_data("/home/student-01-c7eda27642cb/car_sales.json")
